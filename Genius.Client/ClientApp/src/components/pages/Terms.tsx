          ...
          <div className="col-12 -mb-5">
            <div className="-reveal">
              ...
              <ul>
                ...
                <li>
                  <p>
                    ...
                    THEWONDERFULCOMPANYWHOMAKEIT (i mean, it's a college
                    project).
                  </p>
                </li>
                <li>
              ...
              <p>
                ...
                <a href="@url('privacy')">Privacy Policy</a> of the Company. Our
              ...
              <p>
                ...
                through the Service or 1 EUR if You haven't purchased anything
                through the Service.
              </p>
              <p>
              ...
              <ul>
                <li>
                  By email: lol we don't have an email address. It's just a
                  college project
                </li>
              </ul>
            </div>
