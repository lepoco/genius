        ...
        <div className="row">
          ...
          <div className="col-12 -mb-5">
            <div className="-reveal">
              ...
              <h4 className="-mt-3">Interpretation and Definitions</h4>
              ...
              <ul>
                ...
                <li>
                  <p>
                    ...
                    THEWONDERFULCOMPANYWHOMAKEIT (i mean, it's a college project).
                  </p>
                </li>
                <li>
                  <p>
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to @url(), accessible from{' '}
              ...
              <h4 className="-mt-3">Acknowledgment</h4>
              <p>
              ...
              <p>
                ...
                <a href="@url('privacy')">Privacy Policy</a> of the Company. Our Privacy
              ...
              <h4 className="-mt-3">Termination</h4>
              <p>
              ...
              <p>
                ...
                amount actually paid by You through the Service or 1 EUR if You haven't
              ...
              <h4 className="-mt-3">"AS IS" and "AS AVAILABLE" Disclaimer</h4>
              <p>
              ...
              <h4 className="-mt-3">Disputes Resolution</h4>
              <p>
              ...
              <h4 className="-mt-3">For European Union (EU) Users</h4>
              <p>
                If You are a European Union consumer, you will benefit from any mandatory
                provisions of the law of the country in which you are resident in.
              </p>
              <h4 className="-mt-3">United States Legal Compliance</h4>
              <p>
              ...
              <h4 className="-mt-3">Severability and Waiver</h4>
              <h5>Severability</h5>
              <p>
              ...
              <h4 className="-mt-3">Translation Interpretation</h4>
              <p>
                These Terms and Conditions may have been translated if We have made them
                available to You on our Service. You agree that the original English text
                shall prevail in the case of a dispute.
              </p>
              <h4 className="-mt-3">Changes to These Terms and Conditions</h4>
              <p>
              ...
              <ul>
                <li>
                  By email: lol we don't have an email address. It's just a college
                  project
                </li>
              </ul>
            </div>
