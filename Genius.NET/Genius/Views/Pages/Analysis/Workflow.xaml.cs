...
namespace Genius.Views.Pages.Analysis
{
    ...
    public partial class Workflow : Page
    {
        ...
        private void LoadNextCondition()
        {
            this._activeCondition = this._currentSolver.NextCondition();
            Genius.Code.Engine.Condition? nextCondition = Code.GH.CurrentExpertSystem.KnowledgeBase.GetConditionById(this._activeCondition);

            if (nextCondition != null)
                textSearchedCondition.Text = nextCondition.Name;
        }
